...
public class AustinConstant {
     ...
     * 如果新建模板/账号时，没传入则用该常量
     */
    public static final String DEFAULT_CREATOR = "Zhaoxl";
    public static final String DEFAULT_UPDATOR = "Zhaoxl";
    public static final String DEFAULT_TEAM = "Zhaoxl";
    public static final String DEFAULT_AUDITOR = "Zhaoxl";
    /**
     * 项目打印常量
     */
